...
- To compile and run, just do ./run.sh in a terminal from this directory:
  ...
  - if the first argument is either conf, config or configuration:
    ...
    - if no more arguments, it will start the eval loop after configuration
...
- To test the NaLaQ API with kotlin, run scripts/kotlin.kts
- For more usage examples, see the scripts folder
- You will need to run the install script before running test and script examples
...
- This is not ready for production! You have been warned!
